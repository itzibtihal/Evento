        ...
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                <div class="card" style="height: 700px; overflow-y: auto;">
                    ...
                    <form class="form-card" action="{{ route('event.store') }}" method="post"
                        ...
                        <div class="form-group col-sm-12 flex-column d-flex">
                            ...
                            <input type="file" name="event_banner" accept="image/*" required>
                        </div>
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex">
                                <label class="form-control-label px-3">Duration (h)<span class="text-danger">
                                        *</span></label>
                                <input type="number" name="duration_of_event">
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_event"
                                        value="auto-accepted">
                                    <label class="form-check-label">Auto-Accepted</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status_event"
                                        value="needs-acceptation">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-sm-6">
                                <button type="submit" class="btn-block" style="background-color: bisque;">Create
                                    Event</button>
                            </div>
                        </div>
